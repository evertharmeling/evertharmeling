...
- ![](./assets/pr-merged.svg) [Minor typo in basics.md](https://github.com/makinacorpus/DbToolsBundle/pull/118) on [makinacorpus/DbToolsBundle](https://github.com/makinacorpus/DbToolsBundle) (2 days ago)
...
- ![](./assets/pr-merged.svg) [[StimulusBundle] Add support for typescript controllers](https://github.com/symfony/ux/pull/1335) on [symfony/ux](https://github.com/symfony/ux) (3 months ago)
...
- [symfony/ux](https://github.com/symfony/ux) ([v2.16.0](https://github.com/symfony/ux/releases/tag/v2.16.0), 1 week ago) - Symfony UX initiative: a JavaScript ecosystem for Symfony
- [SymfonyCasts/sass-bundle](https://github.com/SymfonyCasts/sass-bundle) ([v0.6.0](https://github.com/SymfonyCasts/sass-bundle/releases/tag/v0.6.0), 2 weeks ago) - Delightful Sass Support for Symfony &#43; AssetMapper
- [prestaconcept/PrestaSitemapBundle](https://github.com/prestaconcept/PrestaSitemapBundle) ([v4.1.0](https://github.com/prestaconcept/PrestaSitemapBundle/releases/tag/v4.1.0), 4 weeks ago) - A symfony bundle that provides tools to build a rich application sitemap. The main goals are : simple, no databases, various namespace (eg. google image), respect constraints etc.
- [doctrine/DoctrineBundle](https://github.com/doctrine/DoctrineBundle) ([2.11.3](https://github.com/doctrine/DoctrineBundle/releases/tag/2.11.3), 1 month ago) - Symfony Bundle for Doctrine ORM and DBAL
